...
def build_costa_dann_fd002_to_fd001(
    ...
    ###########################################################################
    # SHARED GRU FEATURE EXTRACTOR (Costa et al. Figure 5, GRU variant)
    ###########################################################################
    ...
    # Reference: Costa et al. (2019), Section 3.4 "LSTM Deep Adversarial NN" (GRU variant)
    ###########################################################################
    
    input_layer = keras.layers.Input(shape=input_shape, name='sensor_input')
    
    # GRU layer (single layer, configurable units and dropout)
    ...
    ###########################################################################
    # RUL PREDICTOR BRANCH (Costa et al. Figure 5, GRU variant)
    ###########################################################################
    ...
    # Hidden layer (single layer with optional dropout, GRU variant always uses 1 layer)
    ...
    if rul_dropout > 0.0:
        rul_hidden = keras.layers.Dropout(rul_dropout, name='rul_dropout')(rul_hidden)
...
if __name__ == '__main__':
    ...
    print("\n" + "="*40)
    print("Configuration 1: FD002  FD001 (GRU variant)")
    print("="*40)
    ...
    print("\nFD002FD001 Specifications (GRU variant):")
    print("GRU: 1 layer (64 units), dropout 0.1")
    ...
    print("\n" + "="*40)
    print("Configuration 2: FD003  FD001 (GRU variant)")
    print("="*40)
    ...
    print("\nFD003FD001 Specifications (GRU variant):")
    print("GRU: 1 layer (64 units), dropout 0.3")
    print("Feature: 128 units")
    print("RUL: 1 layer (32 units), dropout 0.1")
